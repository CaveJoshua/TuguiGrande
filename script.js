document.addEventListener('DOMContentLoaded', () => {
    ...
    const showPage = (pageId, pageTitle) => {
        ...
        if (pageId === 'dashboard') {
            ...
            content = `<div class="officials-grid"><div class="official-card"><div class="photo-placeholder"><i class="fas fa-user-tie"></i></div><h4>Juan Dela Cruz</h4><p>Punong Barangay</p></div></div>`;
        } else {
    ...
    // This is the code that makes the chat window appear and disappear
